...
class FeatureValidator(models.Model):
    """
    Валидатор значений для конкретной характеристики, придналежащей к конкретной категории
    """
    category = models.ForeignKey('mainapp.Category', verbose_name='Категории', on_delete=models.CASCADE)
...
# TODO: звірити всі файли, зробити вивод характеристик, переробити дизайн, доробити сайт до кінця